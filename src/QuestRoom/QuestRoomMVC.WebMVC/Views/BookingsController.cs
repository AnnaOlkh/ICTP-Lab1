...
namespace QuestRoomMVC.WebMVC.Views
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,ScheduleId,PlayersNumber,Comment,Id")] Booking booking)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.User, "Id", "FirstName", booking.UserId);
            return View(booking);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,ScheduleId,PlayersNumber,Comment,Id")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
